            ...
            <div className="flex justify-center w-full items-center">
              <div className="p-5 lg:p-10 rounded-lg space-y-5 border border-[#c4c4c4]">
                <div className="flex cursor-pointer items-center justify-center">
                  ...
                  />
                  <h1 className="italic text-2xl font-extrabold -ml-3 text-[#0e1724]">
                    elance
                  </h1>
                </div>
                <div
                  onClick={() => signIn("facebook")}
                  className="bg-[#3F51B5] px-8 py-2 rounded-md flex items-center space-x-5 w-full cursor-pointer"
                >
                  <img
                    loading="lazy"
                    className="w-8 h-8"
                    src="https://img.icons8.com/ios-filled/150/ffffff/facebook-new.png"
                  />
                ...
                <div
                  ...
                  className="bg-[#404040] px-8 py-2 rounded-md flex items-center space-x-5 w-full cursor-pointer"
                >
                  <img
                    loading="lazy"
                    className="w-8 h-8"
                    src="https://img.icons8.com/ios-filled/150/ffffff/github.png"
                  />
                  <h1 className="text-white text-sm lg:text-base font-semibold">
                ...
                <div className="w-full flex items-center py-5">
                  ...
                  <h1 className="mx-5 text-[#666666] font-semibold">OR</h1>
                  <div className="bg-[#c4c4c4] h-0.5 w-full" />
                </div>
                <div className="flex cursor-pointer items-center justify-center">
                  <button
                    ...
                    onClick={() =>
                      signIn("testEmail", {
                        email: "developertejas@gmail.com",
                      })
                    }
                  >
                ...
                <div className="flex items-center justify-center">
                  ...
                  <h1
                    ...
                    className="mx-1 text-[#29b2fe] cursor-pointer hover:underline"
                  >
                    Signup
                  </h1>
                  instead?
