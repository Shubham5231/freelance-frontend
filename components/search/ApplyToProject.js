  ...
  async function validateAndApply() {
    if (
      ...
      const res = await fetch(
        "http://localhost:5000/api/v1/hire/applyProject",
        {
          method: "POST",
          headers: {
      ...
      {!isRequestSuccess && (
        <div>
          ...
          <div className="p-5 space-y-2">
            <h1>A short message to the job poster? *</h1>
          ...
          <div className="p-5 space-y-2">
            <h1>How many months are available to work? *</h1>
            <div className={`border border-[#c4c4c4] rounded-md p-2`}>
              <input
                ref={durationInpRef}
                className="w-full focus:outline-none"
          ...
          <div className="p-5 space-y-2">
            <h1>How much hourly rate are you expecting? *</h1>
            <div className={`border border-[#c4c4c4] rounded-md p-2`}>
              <input
                ref={bidInpRef}
                className="w-full focus:outline-none"
      ...
      {isRequestSuccess && (
        <div className="p-5 space-y-3 ">
          <h1 className="text-center text-2xl font-semibold text-[#29b2fe]">
            Your application request has been sent !
          </h1>
