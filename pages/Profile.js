...
function Profile({ profile }) {
  ...
  async function submitReviweRating() {
    if (myGivenRating && myGivenReviewInpRef.current.value) {
      ...
      const res = await fetch("http://localhost:5000/api/v1/users/setReview", {
        method: "POST",
        headers: {
    ...
    <div>
      ...
      {(session || (profile && profile.name)) && (
        <div className="h-60 bg-[#666666] lg:flex justify-center space-x-5">
          <h1 className="text-white font-bold text-2xl text-center pt-10">
        ...
        <div className={`mx-8 lg:mx-60 mb-10 mt-5 lg:-mt-32 space-y-5`}>
          <div className="justify-center bg-white border border-[#c4c4c4] rounded-md">
            <div className="justify-between border-b border-[#c4c4c4] flex items-center p-5">
              <h1 className="text-black font-bold text-lg italic">About</h1>
            ...
            <div className="p-5 lg:flex lg:space-x-5">
              ...
              <div className="space-y-5">
                <div>
                  <h1 className="text-black font-bold text-lg italic">Intro</h1>
                ...
                <div className="lg:grid lg:grid-cols-3">
                  <div>
                    ...
                    <h1 className="text-black text-lg">{profile.occupation}</h1>
                  </div>
                  <div>
                    <h1 className="text-black font-bold text-lg italic">
                      Phone
                ...
                <div className="space-y-2">
                  ...
                  <h1>
                    {profile.qualifications[0]
                      ? profile.qualifications[0].degree
                      : "unknown"}
                  </h1>
                </div>
                <div className="space-y-2">
                  ...
                  <h1>{profile.skills.map((skill) => skill.name + " | ")}</h1>
                </div>
                <div className="lg:grid lg:grid-cols-2 space-y-3 lg:space-y-0">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-3">
                      <SocialIconPopover
                        ...
                        title={
                          <div className="p-1 text-base text-[#29b2fe] hover:underline">
                            {profile.socialProfiles[0]
                              ? profile.socialProfiles[0].url
                              : "unknown"}
                          </div>
                        }
                      >
                        <img
                          className="w-8 h-8 cursor-pointer transition duration-150 transform hover:scale-110"
                      ...
                      <SocialIconPopover
                        ...
                        title={
                          <div className="p-1 text-base text-[#29b2fe] hover:underline">
                            {profile.socialProfiles[1]
                              ? profile.socialProfiles[1].url
                              : "unknown"}
                          </div>
                        }
                      >
                      ...
                      <SocialIconPopover
                        ...
                        title={
                          <div className="p-1 text-base text-[#29b2fe] hover:underline">
                            {profile.socialProfiles[2]
                              ? profile.socialProfiles[2].url
                              : "unknown"}
                          </div>
                        }
                      >
                  ...
                  {!isMyProfile && (
                    <div className="flex items-center space-x-5">
                      <button
                        ...
                        className="bg-[#29b2fe] text-sm lg:text-base text-white font-semibold px-5 h-9 rounded-md hover:bg-[#238ac2] focus:outline-none mt-10"
                      >
                        Message
                      </button>
                  ...
                  <Dialog open={hireDialogOpen} onClose={handleHireDialogClose}>
                    <div>
                      <HireFreelancer
              ...
              <div className="p-3 space-y-3 rounded-b-md text-center border border-[#c4c4c4]">
                ...
                <div>
                  <Link href={project.project_url}>
                    <h1 className="font-semibold text-[#29b2fe] cursor-pointer">
                      view project
                    </h1>
                  </Link>
                </div>
            ...
            <div className="justify-between border border-[#c4c4c4] rounded-b-md p-5 space-y-5">
              {!isMyProfile &&
                !(
                  session &&
                  profile.reviews
                    .map((review) => review.reviewedBy._id)
                    .includes(session.user.elanceprofile.user[0]._id)
                ) && (
                  <div className="w-full space-y-3">
                    ...
                    <RatingSet
                      handleRating={handleMyGivenRating}
                      editable={true}
                    />
                    <textarea
                      type="text"
                    ...
                    <div className="flex justify-between">
                      <div />
                      <h1
                        onClick={submitReviweRating}
                        className="text-white font font-semibold px-4 py-2 bg-[#29b2fe] hover:bg-[#238ac2] rounded-md text-right cursor-pointer"
                      >
                        Send
                      </h1>
                    </div>
              ...
              {profile.reviews &&
                profile.reviews.map((review) => (
                  <div className="space-y-2 m-1">
                    <h1
                      onClick={() =>
                        router.push(`/Profile?id=${review.reviewedBy._id}`)
                      }
                      className="cursor-pointer text-lg text-[#29b2fe] hover:underline font-semibold"
                    >
...
export async function getServerSideProps(context) {
  ...
  if (userId) {
    ...
    const otherUserProfile = await fetch(
