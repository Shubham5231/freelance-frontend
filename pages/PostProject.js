...
function PostProject() {
  ...
  const validateStep3 = () => {
    if (
      locationInpRef.current.value &&
      equipReqInpRef.current.value &&
      freelancerCountInpRef.current.value &&
      durationInpRef.current.value
    ) {
  ...
  async function postproject() {
    ...
    const res = await fetch(
      "http://localhost:5000/api/v1/projects/createProject",
      {
        method: "POST",
        headers: {
      ...
      <div className="lg:mx-32 mx-5 my-3">
        <div className="lg:grid lg:grid-cols-10 mt-10">
          <div className="flex lg:flex-col lg:col-span-3 lg:space-y-5 mb-5">
            <div
              className={`flex space-x-5 pl-5 items-center lg:border-l-4 ${
                currStep === "1" ? "border-[#29b2fe]" : "border-[#ffffff]"
              }`}
            >
              <img
                className="h-8 w-8"
                src={`https://img.icons8.com/ios-filled/150/${
                  currStep >= "1" ? "29b2fe" : "C4C4C4"
                }/edit-image.png`}
              />
              <h1 className="hidden lg:flex text-lg font-semibold text-[#000000]">
                About Project
              </h1>
              <img
                className="hidden lg:flex h-8 w-8"
                src={`https://img.icons8.com/ios-glyphs/120/${
                  currStep > "1" ? "29b2fe" : "C4C4C4"
                }/checked--v1.png`}
              />
            </div>
            <div
              className={`flex space-x-5 pl-5 items-center lg:border-l-4 ${
                currStep === "2" ? "border-[#29b2fe]" : "border-[#ffffff]"
              }`}
            >
              <img
                className="h-8 w-8"
                src={`https://img.icons8.com/ios-filled/100/${
                  currStep >= "2" ? "29b2fe" : "C4C4C4"
                }/visualization-skill.png`}
              />
              <h1 className="hidden lg:flex text-lg font-semibold text-[#000000]">
                Skills Required
              </h1>
            ...
            <div
              className={`flex space-x-5 pl-5 items-center lg:border-l-4 ${
                currStep === "3" ? "border-[#29b2fe]" : "border-[#ffffff]"
              }`}
            >
              <img
                className="h-8 w-8"
                src={`https://img.icons8.com/material-outlined/192/${
                  currStep >= "3" ? "29b2fe" : "C4C4C4"
                }/details-pane.png`}
              />
              <h1 className="hidden lg:flex text-lg font-semibold text-[#000000]">
                Details
            ...
            <div
              className={`flex space-x-5 pl-5 items-center lg:border-l-4 ${
                currStep === "4" ? "border-[#29b2fe]" : "border-[#ffffff]"
              }`}
            >
              <img
                className="h-8 w-8"
                src={`https://img.icons8.com/material/144/${
                  currStep >= "4" ? "29b2fe" : "C4C4C4"
                }/visible--v1.png`}
              />
              <h1 className="hidden lg:flex text-lg font-semibold text-[#000000]">
                Visibility
            ...
            <div
              className={`flex space-x-5 pl-5 items-center lg:border-l-4 ${
                currStep === "5" ? "border-[#29b2fe]" : "border-[#ffffff]"
              }`}
            >
              <img
                className="h-8 w-8"
                src={`https://img.icons8.com/ios-filled/100/${
                  currStep >= "5" ? "29b2fe" : "C4C4C4"
                }/rupee.png`}
              />
              <h1 className="hidden lg:flex text-lg font-semibold text-[#000000]">
                Budget
            ...
            <div
              className={`flex space-x-5 pl-5 items-center lg:border-l-4 ${
                currStep === "6" ? "border-[#29b2fe]" : "border-[#ffffff]"
              }`}
            >
              <img
                className="h-8 w-8"
                src={`https://img.icons8.com/ios-filled/100/${
                  currStep >= "6" ? "29b2fe" : "C4C4C4"
                }/double-tick.png`}
              />
              <h1 className="hidden lg:flex text-lg font-semibold text-[#000000]">
                Review
          ...
          <div className="lg:col-span-7">
            ...
            <div className={`w-full ${currStep !== "1" && "hidden"}`}>
              <div className="border border-gray-300 w-full rounded-md">
                <div className="p-5 space-y-2 border-b border-gray-300">
                  <h1 className=" font-semibold text-[#666666] text-lg">
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                    <img
                      className="w-6 h-6"
                      src="https://img.icons8.com/ios-glyphs/90/666666/edit.png"
                    />
                    <input
                      type="text"
                      ref={projNameInpRef}
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-start space-x-3 pt-3">
                    <img
                      className="w-6 h-6"
                      src="https://img.icons8.com/ios-glyphs/120/666666/view-details.png"
                    />
                    <textarea
                      type="text"
                      rows="5"
                ...
                <div className="flex cursor-pointer items-center p-5 justify-end">
                  ...
                  <button
                    ...
                    className="px-6 py-3 text-white bg-[#29b2fe] hover:bg-[#41a8e0] rounded-md place-self-center focus:outline-none text-sm font-semibold"
                  >
                    Continue
                  </button>
                </div>
            ...
            <div className={`w-full ${currStep !== "2" && "hidden"}`}>
              <div className="border border-gray-300 w-full rounded-md">
                ...
                <div className="p-5 space-y-3">
                  <h1 className="text-[#000000] font-bold">
                    Enter the skills your project requires
                  </h1>
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                    <img
                      className="w-6 h-6"
                      src="https://img.icons8.com/ios-filled/100/666666/visualization-skill.png"
                    />
                    <input
                      type="text"
                      ref={skillsInpRef}
                ...
                <div className="p-5 space-y-3">
                  <h1 className="text-[#000000] font-bold">
                    Enter any educational qualififications your project requires
                  </h1>
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                    <img
                      className="w-6 h-6"
                      src="https://img.icons8.com/ios-glyphs/120/666666/education.png"
                    />
                    <input
                      type="text"
                ...
                <div className="flex cursor-pointer items-center px-5 pb-3 justify-end space-x-5">
                  <button
                    ...
                    className="px-6 py-3 text-[#29b2fe] bg-white border border-[#29b2fe] font-semibold rounded-md place-self-center focus:outline-none text-sm"
                  >
                    Previous
                  </button>
                  <button
            ...
            <div className={`w-full ${currStep !== "3" && "hidden"}`}>
              <div className="border border-gray-300 w-full rounded-md">
                ...
                <div className="p-5 space-y-3">
                  <h1 className="text-[#000000] font-bold">
                    What is the working location for the project
                  </h1>
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                    <img
                      className="w-6 h-6"
                      src="https://img.icons8.com/glyph-neue/128/666666/user-location.png"
                    />
                    <input
                      type="text"
                      ref={locationInpRef}
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                    <img
                      className="w-6 h-6"
                      src="https://img.icons8.com/ios-filled/150/666666/servers-group.png"
                    />
                    <input
                      type="text"
                      ref={equipReqInpRef}
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                    <img
                      className="w-6 h-6"
                      src="https://img.icons8.com/ios-filled/128/666666/child-safe-zone--v2.png"
                    />
                    <input
                      type="number"
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                    <img
                      className="w-6 h-6"
                      src="https://img.icons8.com/ios-filled/150/666666/clock--v3.png"
                    />
                    <input
                      type="number"
                      ref={durationInpRef}
            ...
            <div className={`w-full ${currStep !== "4" && "hidden"}`}>
              <div className="border border-gray-300 w-full rounded-md">
                <div className="p-5 space-y-2 border-b border-gray-300">
                  <h1 className=" font-semibold text-[#666666] text-lg">
                    Control visibility of your job posting
                  </h1>
                ...
                <div className="p-5 space-y-3">
                  <h1 className="text-[#000000] font-bold">
                    Your project is visible to freelancers who has :
                  </h1>
                  <div className="flex rounded-lg px-3 py-1 items-center space-x-3 cursor-pointer">
                    ...
                    <CustomCheckbox />
                    <h1 className="text-lg font-semibold text-[#666666]">
                      Matching Skill Set
                    </h1>
                  </div>
                  <div className="flex rounded-lg px-3 py-1 items-center space-x-3 cursor-pointer">
            ...
            <div className={`w-full ${currStep !== "5" && "hidden"}`}>
              <div className="border border-gray-300 w-full rounded-md">
                <div className="p-5 space-y-2 border-b border-gray-300">
                  <h1 className=" font-semibold text-[#666666] text-lg">
                    Project Budget and Hourly Rate
                  </h1>
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                    <img
                      className="w-6 h-6"
                      src="https://img.icons8.com/ios-filled/100/666666/rupee.png"
                    />
                    <input
                      type="number"
                      ref={budgetInpRef}
                ...
                <div className="p-5 space-y-3">
                  <h1 className="text-[#000000] font-bold">
                    What is your hourly budget per a freelancer?
                  </h1>
                  <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                    <img
                      className="w-6 h-6"
              ...
              <div className="border border-gray-300 w-full rounded-md">
                ...
                <div className="p-5 space-y-3 border-b border-gray-300">
                  <div className="space-y-2">
                    ...
                    <h1 className="text-[#666666]">{projectDesc}</h1>
                  </div>
                  <div>
                  ...
                  <div>
                    <h1 className="text-black">Qualifications</h1>
                    <h1 className="text-[#666666]">{qualification}</h1>
                  </div>

                  <div>
                    <h1 className="text-black">Additional details</h1>
                    <h1 className="text-[#666666]">
                      Hardware / Software required :{" "}
                      {equipment.replace(/,/g, " | ")}
                    </h1>
                    <h1 className="text-[#666666]">
                      Loking for {count} freelancers for a duration of{" "}
                      {duration} months
                    </h1>
                  </div>
                  <div className="flex space-x-2 items-center">
                    <img
                      className={`w-6 h-6`}
                      src="https://img.icons8.com/ios-filled/100/29b2fe/rupee.png"
                    />
                    <h1 className="text-[#666666]">
                  ...
                  <div className="flex space-x-2 items-center">
                    <img
                      className={`w-6 h-6`}
                      src="https://img.icons8.com/ios-glyphs/120/29b2fe/visible--v1.png"
                    />
                    <h1 className="text-[#666666]">
                      Matching Skill Set | Matching Location | Matching Time
                      Zone | 4+ Star Rating
                    </h1>
                  </div>
                  ...
                  <div className="flex space-x-2 items-center">
                    <img
                      className={`w-6 h-6`}
                      src="https://img.icons8.com/ios-filled/150/29b2fe/marker.png"
                    />
                    <h1 className="text-[#666666]">{location}</h1>
                  </div>
                </div>
