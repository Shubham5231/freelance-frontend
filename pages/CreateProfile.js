      ...
      <div className="border-b border-gray-200">
        <div className="lg:mx-32 mx-5 my-3">
          <div className="flex cursor-pointer items-center">
            ...
            />
            <h1 className="italic text-xl font-extrabold -ml-3 text-[#0e1724]">
              elance
            </h1>
          </div>
        </div>
      ...
      <div className="">
        <div className="w-full items-center my-10">
          <div className="flex justify-center w-full items-center">
            ...
            <div
              id="create_profile_initial"
              className={`${
                createViewContext !== "1" && "hidden"
              } px-1 lg:px-10 py-5 rounded-lg space-y-5 lg:border border-[#c4c4c4]`}
            >
              ...
              <div className="space-y-5 lg:flex lg:space-x-3 lg:space-y-0">
                <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                  <img
                    className="w-6 h-6"
                    src="https://img.icons8.com/ios-glyphs/90/666666/user--v1.png"
                  />
                  <input
                    type="text"
                    defaultValue={f_name}
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/ios-glyphs/90/666666/email.png"
                />
                <input
                  type="text"
              ...
              <div className="space-y-5 hidden lg:space-x-3 lg:space-y-0">
                <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                  <img
                    className="w-6 h-6"
                    src="https://img.icons8.com/metro/104/666666/password.png"
                  />
                  <input
                    type="password"
                    className="border-none focus:outline-none text-[#0e1724] text-s flex-grow flex-shrink w-full h-10"
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-5">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/ios-filled/150/666666/world.png"
                />
              ...
              <div className="flex cursor-pointer items-center justify-center">
                <h1 className="font-extrabold -ml-3 text-[#0e1724]">
                  I want to{" "}
                </h1>
              </div>
              ...
              <div className="space-y-5 lg:flex lg:space-y-0 ">
                <div
                  ...
                  className={`${
                    userType === "client"
                      ? "bg-[#29b2fe] border-[#29b2fe] text-white font-semibold"
                      : "text-[#666666]"
                  } px-8 py-2 border-2 border-gray-400 rounded-md lg:rounded-l-md lg:rounded-r-none flex items-center space-x-5 w-full cursor-pointer `}
                >
                ...
                <div
                  ...
                  className={`${
                    userType === "freelancer"
                      ? "bg-[#29b2fe] border-[#29b2fe] text-white font-semibold"
                      : "text-[#666666]"
                  } border-2 border-gray-400 px-8 py-2 rounded-md lg:rounded-r-md lg:rounded-l-none flex items-center space-x-5 w-full cursor-pointer`}
                >
              ...
              <div className="flex cursor-pointer items-center justify-center">
                <h1
                  className={`text-sm text-[#E74C3C] font-semibold ${
                    isStep1Validated === "F" ? "flex" : "hidden"
                  }`}
                >
                  * Please fill all the details and continue *
                </h1>
              </div>
              <div className="flex cursor-pointer items-center justify-center">
                <button
            ...
            <div
              id="create_profile_second"
              className={`${
                createViewContext !== "2" && "hidden"
              } px-1 lg:px-10 py-5 rounded-lg space-y-5 lg:border border-[#c4c4c4]`}
            >
              <div className="space-y-2">
                <div className="flex cursor-pointer items-center justify-center">
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/ios-filled/100/666666/portfolio.png"
                />
                <input
                  type="text"
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/material-rounded/160/666666/employee-card.png"
                />
                <input
                  type="text"
                  ref={introInputRef}
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/ios-filled/150/666666/apple-phone.png"
                />
                <input
                  type="tel"
                  ref={phoneInputRef}
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/ios-filled/150/666666/linkedin.png"
                />
                <input
                  type="url"
                  ref={linkedInputRef}
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/ios-filled/150/666666/github.png"
                />
                <input
                  type="url"
                  ref={githubInputRef}
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/ios-filled/150/666666/facebook--v1.png"
                />
                <input
                  type="url"
                  ref={fbInputRef}
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/ios-filled/100/666666/resume-website.png"
                />
                <input
                  type="url"
                  ref={websiteInputRef}
              ...
              <div className="flex cursor-pointer items-center justify-center">
                <h1
                  className={`text-sm text-[#E74C3C] font-semibold ${
                    isStep2Validated === "F" ? "flex" : "hidden"
                  }`}
                >
                  * Please fill all the details and continue *
                </h1>
              ...
              <div className="flex cursor-pointer items-center justify-center space-x-5">
                <button
                  onClick={() => setViewContext("1")}
                  type="submit"
                  className="px-6 py-3 text-[#29b2fe] bg-white border border-[#29b2fe] rounded-md place-self-center focus:outline-none text-sm font-semibold"
                >
                  Previous
                </button>
                <button
            ...
            <div
              id="create_profile_third"
              className={`${
                createViewContext !== "3" && "hidden"
              } px-1 lg:px-10 py-5 rounded-lg space-y-5 lg:border border-[#c4c4c4]`}
            >
              <div className="space-y-2">
                <div className="flex cursor-pointer items-center justify-center">
                ...
                <div className="flex cursor-pointer items-center justify-center">
                  <h1 className="">
                    Tell us about your 3 prominent works and projects
                  </h1>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                  <img
                    className="w-6 h-6"
                    src="https://img.icons8.com/ios-filled/100/666666/title.png"
                  />
                  <input
                    type="text"
                ...
                <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                  <img
                    className="w-6 h-6"
                    src="https://img.icons8.com/material-outlined/96/666666/details-pane.png"
                  />
                  <input
                    type="text"
              ...
              <div className="flex cursor-pointer items-center justify-center">
                <h1
                  className={`text-sm text-[#E74C3C] font-semibold ${
                    isStep3Validated === "F" ? "flex" : "hidden"
                  }`}
                >
                  * Please fill all the details and continue *
                </h1>
            ...
            >
              ...
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                ...
                <input
                  ...
                  placeholder={
                    userType === "F"
                      ? "Add your skills separated by ( , )"
                      : "Add required skills separated by ( , )"
                  }
                />
              </div>
              <h1>Education</h1>
              <div className="flex border-2 border-gray-400 focus-within:border-[#0e1724] rounded-lg px-3 py-1 items-center space-x-3">
                <img
                  className="w-6 h-6"
                  src="https://img.icons8.com/ios-filled/100/666666/education.png"
                />
                <input
                  type="text"
              ...
              <div className="flex cursor-pointer items-center justify-center">
                <h1
                  className={`text-sm text-[#E74C3C] font-semibold ${
                    isStep4Validated === "F" ? "flex" : "hidden"
                  }`}
                >
                  * Please fill all the details and continue *
                </h1>
          ...
          <div className="text-center m-5 text-[#E74C3C] font-semibold">
            {errorMessage}
          </div>
        </div>
      </div>
